...
public class OrderControl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("all")) {
			...
			try {
				if(user.isValid()) {
					//implementazione dell'aggiunta della tupla in prenotazione, vanno settati prima i metodi nel OrderDao e nel productDao
				}
				}catch(SQLException e) {System.out.println("the error was: "+e);}//errore dovuto  al fatto che non c'è anccora il comando sql
			}
		}
